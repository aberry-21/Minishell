...
/*   Updated: 2021/01/30 21:27:20 by telron           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_parse_element	*ft_parse_command_create(t_dlist *dlist_string)
{
	...
	if (new_element)
	{
		...
		new_element->content.command.dlist_string = dlist_string;

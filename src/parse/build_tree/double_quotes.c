...
/*   Updated: 2021/02/07 05:45:41 by telron           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

static int		ft_error_handler(t_shell *config, t_parse_element *element,\
...
t_parse_element	*ft_parse_build_double_quotes(t_shell *config, char **str, t_dlist **dlist)
{
	t_line			*line;

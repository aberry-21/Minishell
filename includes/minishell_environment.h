...
/*   Updated: 2021/05/18 20:16:47 by telron           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_variable		*ft_env_var_change_by_user(t_shell *config,\
												const char *import_variable);
void			ft_env_delete_env(t_shell *config);
void			ft_env_var_delone(t_dict *environment,\
											t_variable *variable, const char *key);
t_variable		*ft_env_var_new(t_dict **environment,\
							const char *import_variable, size_t index_equally);
void			ft_env_var_init_others(t_shell *config, t_dict **environment,\
							const char *import_variable, size_t index_equally);
void			ft_env_var_init_home(t_shell *config, t_dict **environment,\
													void *ft_dynamic_value);
void			ft_env_var_init_shlvl(t_shell *config, t_dict **environment,\
														void *ft_dynamic_value);
void			ft_env_var_init_pwd(t_shell *config, t_dict **environment,\
														void *ft_dynamic_value);
void			ft_env_var_dv_pwd(t_shell *config, t_variable *var_pwd);
void			ft_env_var_init_oldpwd(t_shell *config, t_dict **environment,\
														void *ft_dynamic_value);
void			ft_env_var_init_random(t_shell *config, t_dict **environment,\
														void *ft_dynamic_value);
void			ft_env_var_dv_random(t_shell *config, t_variable *var_random);
void			ft_env_var_init_pid(t_shell *config, t_dict **environment,\
														void *ft_dynamic_value);
void			ft_env_var_init_code_exit(t_shell *config,\

...
/*   Updated: 2021/03/02 10:46:28 by telron           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			ft_parse_wildcard_recursion(t_dlist **res, t_line *pat, t_line *org_pat);
...
int			ft_ret(t_line *path, t_line *pattern, t_line *pattern_tmp, char **pattern_array);
void		ft_init_variable(t_line **path, char ***pat_arr, t_line **pat_tmp);
int			ft_add_or_recursion(t_dlist **res, t_line *path, t_line *tmp, t_line *org_pat);
